...
public class BoyAnimationScript : MonoBehaviour {
    ...
    void Jumping(bool b) { if (playerAnimator != null) playerAnimator.SetBool("isJumping", b); }
    void Gliding(bool b) { if (playerAnimator != null) playerAnimator.SetBool("isGliding", b); }
